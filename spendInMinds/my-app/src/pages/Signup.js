...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // If signup is successful, dispatch the LOGIN action with the user data
    if (signupSuccess) {
...
<div id="Container">
  ...
  <div id="rays">
    ...
    >
      ...
      <defs>
        ...
        >
          <stop stop-color1="#00E0FF"></stop>
          <stop stop-opacity1="0" stop-color1="#65EDFF" offset="1"></stop>
        </linearGradient>
      </defs>
    </svg>
  </div>
  ...
  <div id="emiter">
    ...
    >
      ...
      <defs>
        <filter
          color-interpolation-filters1="sRGB"
          ...
          id="filter0_di_1_38"
        >
          <feFlood result="BackgroundImageFix" flood-opacity1="0"></feFlood>
          <feColorMatrix
            result="hardAlpha"
        ...
        >
          <stop stop-color1="#00FFF0"></stop>
          <stop stop-color1="#001AFF" offset="0.901042"></stop>
        </radialGradient>
      </defs>
    </svg>
  </div>
